...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, k, d) { b != Array.prototype && b != Object.prototype && (b[k] = d.value) };
...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, d, n) {
        ...
        if ("function" == typeof p) { b = p.call(b); for (var t = 0; !(p = b.next()).done;) k.push(d.call(n, p.value, t++)) } else
            for (p = b.length, t = 0; t < p; t++) k.push(d.call(n, b[t], t));
        return k
    }
}, "es6", "es3");
$jscomp.owns = function(b, k) { return Object.prototype.hasOwnProperty.call(b, k) };
...
$jscomp.findInternal = function(b, k, d) { b instanceof String && (b = String(b)); for (var n = b.length, l = 0; l < n; l++) { var p = b[l]; if (k.call(d, p, l, b)) return { i: l, v: p } } return { i: -1, v: void 0 } };
...
$jscomp.polyfill("Array.prototype.includes", function(b) {
    return b ? b : function(b, d) {
        ...
        var l = k.length;
        d = d || 0;
        for (0 > d && (d = Math.max(d + l, 0)); d < l; d++) { var p = k[d]; if (p === b || Object.is(p, b)) return !0 }
        return !1
    }
}, "es7", "es3");
...
(function() {
    ...
    function k(a) { a = a.getBoundingClientRect(); return { top: a.top + document.body.scrollTop, left: a.left + document.body.scrollLeft } }

    function d(a) { return parseFloat(getComputedStyle(a, null).height.replace("px", "")) }

    function n(a) { return parseFloat(getComputedStyle(a, null).width.replace("px", "")) }
    ...
    function z(a) {
        ...
        a.querySelectorAll(".carousel-indicators > li").forEach(function(a) { b ? a.setAttribute("data-bs-target", "#" + c) : a.setAttribute("data-target", "#" + c) });
        C(a)
    }
    ...
    function D(a) {
        ...
        a.querySelectorAll(".carousel-item .col-md-12").forEach(function(a) { 2 > b ? a.setAttribute("class", "col-md-12") : "5" == b ? a.setAttribute("class", "col-md-12 col-lg-15") : a.setAttribute("class", "col-md-12 col-lg-" + 12 / b) });
    ...
    Element.prototype.parents =
        function(a) { for (var b = [], f = this, g = void 0 !== a; null !== (f = f.parentElement);) f.nodeType === Node.ELEMENT_NODE && (g && !f.matches(a) || b.push(f)); return b };
    Element.prototype.footerReveal = function() {
        function a() {!f && this.offsetHeight <= window.outerHeight ? (this.style.zIndex = "-999", this.style.position = "fixed", this.style.bottom = "0", this.style.width = b.offsetWidth, b.style.marginBottom = this.offsetHeight) : (this.style.zIndex = "", this.style.position = "", this.style.bottom = "", this.style.width = "", b.style.marginBottom = "") }
        var b =
    ...
    l(function() {
        function a(a) { a.style.height = 9 * n(a.parentNode) / 16 + "px" }
        ...
        }(window.innerWidth, window.innerHeight) : G || (window.smartresize(function() { document.querySelector(".mbr-section--full-height").style.height = window.innerHeight + "px" }), h(document).on("add.cards", function(a) { document.querySelector("html").classList.contains("mbr-site-loaded") && b(a.target, ".mbr-section--full-height").length && window.dispatchEvent(new CustomEvent("resize")) }));
        ...
        window.smartresize(function() { document.querySelectorAll(".mbr-embedded-video").forEach(function(a) { a.style.height = (n(a) * parseInt(a.getAttribute("height") || 315) / parseInt(a.getAttribute("width") || 560)).toFixed() + "px" }) });
        ...
        if (m) {
            if (!r) return;
            h(document).on("add.cards", function(a) { f(a.target) })
    ...
    if (!m) {
        ...
        if (r) h(document).on("add.cards", function(a) { a.target.classList.contains("mbr-reveal") && a.target.footerReveal() });
        l(function() {
            if (!w() && document.querySelectorAll("input[name=animation]").length) {
                ...
                g = g.filter(function(a) { if (!a.parents().filter(function(a) { if (a.matches("a, p, .navbar, .mbr-arrow, footer, .iconbox, .mbr-slider, .mbr-gallery, .mbr-testimonial .card-block, #cookiesdirective, .mbr-wowslider, .accordion, .tab-content, .engine, #scrollToTop")) return !0 }).length) return !0 });
    ...
    l(function() {
        if (document.querySelectorAll(".mbr-arrow-up").length) {
            ...
            window.addEventListener("scroll", function() { window.scrollY > window.innerHeight ? t(a) : p(a) });
        ...
        if (!m) {
            var a = function(a) { b(a.target) },
                b = function(b) {
                    ...
                    b.parents("section").forEach(function(a) { a.style.zIndex = "5000" }); - 1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*");
    ...
    m || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function(a) { a.getAttribute("data-isinit") || (z(a), D(a)) })), "undefined" === typeof window.initPopupBtnPlugin && 0 != document.body.querySelectorAll("section.popup-btn-cards").length && (window.initPopupBtnPlugin = !0, document.querySelectorAll("section.popup-btn-cards .card-wrapper").forEach(function(a) { a.classList.add("popup-btn") })), "undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function(a) { z(a) })), "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0, l(function() {
        ...
        a.addEventListener("slide.bs.carousel", function() {
            b.forEach(function(a) { a.addEventListener("click", g) });
        ...
        a.addEventListener("slid.bs.carousel", function() {
            b.forEach(function(a) { a.removeEventListener("click", g) });
            d.forEach(function(a) { a.removeEventListener("click", g) });
